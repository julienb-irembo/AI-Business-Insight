...
Important: Don't include these columns in your results service name, service category name, institute name, application requester location sector, application requester location district, application requester id, application requester location sector name, application requester location district name, application processing reason and application payment account.
